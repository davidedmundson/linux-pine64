...
struct sunxi_cache_control_cmd {
    int fd;
    bool lock;
};
...
#define DRM_SUNXI_CACHE_CONTROL	0x05
...
#define DRM_IOCTL_SUNXI_CACHE_CONTROL		DRM_IOW(DRM_COMMAND_BASE + \
		DRM_SUNXI_CACHE_CONTROL, struct sunxi_fb_info_cmd)
